...
public class RatingReviewService {
    ...
    public void saveRatingReview(RatingReviewRequest ratingReviewRequest) {
        ...
        RatingReview roomRating = ratingReviewRepository.findById(roomTypeId).orElse(new RatingReview());
    ...
    public RatingReviewResponseDTO getRatingReviewResponse(Long roomTypeId) {
        ...
        return new RatingReviewResponseDTO(
                ratingReview.getPropertyId(),
                ratingReview.getRoomTypeId(),
                ratingReview.getRating(),
                ratingReview.getReviewCount()
        );
    }
}
